        ...
        if (($Tasks = $Folder.GetTasks(1))) {
            $Tasks | Foreach-Object {
	            New-Object -TypeName PSCustomObject -Property @{
                    ...
                    'ActionExecCommands' =  ([xml]$_.xml).Task.Actions.Exec.Command
                    'ActionExecArguments' =  ([xml]$_.xml).Task.Actions.Exec.Arguments
                    'ActionExecDirectory' =  ([xml]$_.xml).Task.Actions.Exec.WorkingDirectory
